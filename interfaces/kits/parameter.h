...
/**
 * @brief Obtains the major (M) version number, which increases with any updates to the overall architecture.
 *
...
/**
 * @brief Obtains the senior (S) version number, which increases with any updates to the partial
 * architecture or major features.
 *
 * The S version number monotonically increases from 10 to 99.\n
 *
...
/**
 * @brief Obtains the feature (F) version number, which increases with any planned new features.
 *
...
/**
 * @brief Obtains the build (B) version number, which increases with each new development build.
 *
